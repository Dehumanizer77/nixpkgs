  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.wazuh-agent-setup = {
      ...
      script = ''
        ...
        mkd "$STATE/queue/syscollector/db"
    ...
    systemd.services.wazuh-modulesd = {
      ...
      serviceConfig = commonServiceConfig // {
        ...
        # Syscollector needs AF_NETLINK to enumerate network interfaces
    ...
    systemd.services.wazuh-syscheckd = {
      ...
      serviceConfig = commonServiceConfig // {
        ...
        # Rootcheck needs AF_INET/AF_INET6/AF_NETLINK to check network interfaces
